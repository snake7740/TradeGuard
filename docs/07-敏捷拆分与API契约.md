...
| 验收 | S7（E7-04~05） | 可观测 + 演示剧本 | 11/11 场景通过 + KPI 报告 | S7 ✅（2026-08-13） |
...
| API-W-20 | `/api/observability/traces` | GET | 技能 span 回放（可观测取证） | US-E7-04 |
| API-W-21 | `/api/demo/subjects` | GET | 演示触发候选主体（无在办案件的账户，limit 1-50） | US-E7-05 |
